...
view_info = 
{
	...
	applies_to = {"", "proc.pid", "proc.name", "container.id", "fd.sport", "fd.sproto", "fd.name", "fd.directory", "fd.containerdirectory", "evt.res", "k8s.pod.id", "k8s.rc.id", "k8s.rs.id", "k8s.svc.id", "k8s.ns.id", "marathon.app.id", "marathon.group.name", "mesos.task.id", "mesos.framework.name"},
	is_root = true,
