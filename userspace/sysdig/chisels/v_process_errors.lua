...
view_info = 
{
	...
	columns = 
	{
		...
		},
		{
			...
			description = "Number of file I/O errors generated by the process.",
			colsize = 8,
			aggregation = "SUM"
		},
		{
			...
			description = "Number of network I/O errors generated by the process.",
			colsize = 8,
			aggregation = "SUM"
		},
		{
			...
			description = "Number of memory allocation/release related errors generated by the process.",
			colsize = 8,
			aggregation = "SUM"
		},
		{
			...
			description = "Number of errors generated by the process that don't fall in any of the previous categories. E.g. signal or event related errors.",
			colsize = 8,
			aggregation = "SUM"
		},
		{
