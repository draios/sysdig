...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_INFRASTRUCTURE_EVENT_E */{"infrastructure_event", EC_INTERNAL, EF_SKIPPARSERESET, 2, {{"type", PT_CHARBUF, PF_DEC}, {"name", PT_CHARBUF, PF_NA}, {"description", PT_CHARBUF, PF_NA}, {"severity", PT_UINT32, PF_NA}, {"scope", PT_CHARBUF, PF_NA}, {"tags", PT_CHARBUF, PF_NA}, } },
	/* PPME_INFRASTRUCTURE_EVENT_E */{"NA4", EC_SYSTEM, EF_UNUSED, 0},
};
