...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_UNLINKAT_E */{"unlinkat", EC_FILE, EF_NONE | EF_OLD_VERSION, 2, {{"dirfd", PT_FD, PF_DEC}, {"name", PT_CHARBUF, PF_NA} } },
	/* PPME_SYSCALL_UNLINKAT_X */{"unlinkat", EC_FILE, EF_NONE | EF_OLD_VERSION, 1, {{"res", PT_ERRNO, PF_DEC} } },
	...
	/* PPME_SYSCALL_UNLINKAT_3_E */{"unlinkat", EC_FILE, EF_NONE, 3, {{"dirfd", PT_FD, PF_DEC}, {"name", PT_CHARBUF, PF_NA}, {"flags", PT_FLAGS8, PF_HEX, unlinkat_flags} } },
	/* PPME_SYSCALL_UNLINKAT_3_X */{"unlinkat", EC_FILE, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC} } },
};
