...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_SPLICE_E */{"splice", EC_IO_READ, EF_USES_FD | EF_READS_FROM_FD, 4, {{"fd_in", PT_FD, PF_DEC}, {"fd_out", PT_FD, PF_DEC}, {"size", PT_UINT64, PF_DEC}, {"flags", PT_FLAGS32, PF_HEX, splice_flags} } },
	/* PPME_SYSCALL_SPLICE_X */{"splice", EC_IO_READ, EF_USES_FD | EF_READS_FROM_FD, 1, {{"res", PT_ERRNO, PF_DEC} } },
