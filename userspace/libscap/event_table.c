...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_FCHMODAT_X */{"fchmodat", EC_FILE, EF_NONE, 5, {{"res", PT_ERRNO, PF_DEC}, {"dirfd", PT_FD, PF_DEC}, {"pathname", PT_FSPATH, PF_NA}, {"mode", PT_UINT32, PF_OCT}, {"flags", PT_FLAGS32, PF_HEX, chown_chmod_flags} } },
};
