...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SOCKET_SOCKET_E */{"socket", EC_NET, (enum ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 3, {{"domain", PT_FLAGS32, PF_DEC, socket_families}, {"type", PT_FLAGS32, PF_DEC, socket_types}, {"proto", PT_UINT32, PF_DEC, inet_protocols} } },
	...
	/* PPME_SOCKET_SOCKETPAIR_E */{"socketpair", EC_IPC, (enum ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 3, {{"domain", PT_FLAGS32, PF_DEC, socket_families}, {"type", PT_FLAGS32, PF_DEC, socket_types}, {"proto", PT_UINT32, PF_DEC, inet_protocols} } },
