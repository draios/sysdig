...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_CHOWN_E */{"chown", EC_FILE, EF_NONE, 3, {{"pathname", PT_FSPATH, PF_NA}, {"owner", PT_UID, PF_DEC}, {"group", PT_GID, PF_DEC} } },
	/* PPME_SYSCALL_CHOWN_X */{"chown", EC_FILE, EF_NONE, 1, {{"res", PT_ERRNO, PF_DEC} } },
