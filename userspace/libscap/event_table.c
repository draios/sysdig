...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SCHEDSWITCH_7_E */{"switch", EC_SCHEDULER, EF_MODIFIES_STATE, 7, {{"next", PT_PID, PF_DEC}, {"pgft_maj", PT_UINT64, PF_DEC}, {"pgft_min", PT_UINT64, PF_DEC}, {"vm_size", PT_UINT32, PF_DEC}, {"vm_rss", PT_UINT32, PF_DEC}, {"vm_swap", PT_UINT32, PF_DEC}, {"next_ppid", PT_PID, PF_DEC} } },
	/* PPME_SCHEDSWITCH_7_X */{"NA6", EC_SCHEDULER, EF_UNUSED, 0}
};
