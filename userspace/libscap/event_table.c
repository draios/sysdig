...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_SEMCTL_X */{"semctl", EC_PROCESS, EF_NONE, 5, {{"res", PT_ERRNO, PF_DEC}, {"semid", PT_INT32, PF_DEC}, {"semnum", PT_INT32, PF_DEC}, {"cmd", PT_FLAGS32, PF_HEX, semctl_commands}, {"val", PT_INT32, PF_DEC} } },
};
