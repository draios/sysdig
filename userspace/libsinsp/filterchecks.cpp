...
inline bool sinsp_filter_check_evtin_tracer::compare_tracer(sinsp_evt *evt, sinsp_partial_tracer* pae)
{
	...
	//
	// If this is a *.t.* field, reject anything that doesn't match the thread
	//
	if(m_field_id >= TYPE_TRACER_T_ID && m_field_id <= TYPE_TRACER_T_ARG)
	{
