...
const filtercheck_field_info sinsp_filter_check_thread_fields[] =
{
	...
	{PT_CHARBUF, EPF_NONE, PF_NA, "thread.cgroups", "the cgroups the thread belongs to."},
	{PT_CHARBUF, EPF_NONE, PF_NA, "thread.container", "the container id the thread belongs to."},
	{PT_INT64, EPF_NONE, PF_DEC, "thread.vtid", "the virtual id of the thread generating the event."},
	{PT_INT64, EPF_NONE, PF_DEC, "proc.vpid", "the virtual id of the process generating the event."},
