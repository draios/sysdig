...
public:
	...
	{
		SEV_EVT_MDUMP_EMERGENCY = 20,
		SEV_EVT_MDUMP_FATAL = 21,
		SEV_EVT_MDUMP_CRITICAL = 22,
		SEV_EVT_MDUMP_ERROR = 23,
		SEV_EVT_MDUMP_WARNING = 24,
		SEV_EVT_MDUMP_NOTICE = 25,
		SEV_EVT_MDUMP_INFORMATION = 26,
		SEV_EVT_MDUMP_DEBUG = 27,
		SEV_EVT_MDUMP_MIN = SEV_EVT_MDUMP_EMERGENCY,
		SEV_EVT_MDUMP_MAX = SEV_EVT_MDUMP_DEBUG
	};
