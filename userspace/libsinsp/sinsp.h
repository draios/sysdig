...
public:
	...
	*/
	...
	static inline bool simple_comsumer_consider_evtnum(uint16_t etype)
	{
		enum ppm_event_flags flags = g_infotables.m_event_info[etype].flags;

		return ! (flags & sinsp::simple_comsumer_skip_flags());
	}

	static inline bool simple_comsumer_consider_syscallid(uint16_t scid)
	{
...
VISIBILITY_PRIVATE
        ...
        static inline ppm_event_flags simple_comsumer_skip_flags()
        {
