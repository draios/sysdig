...
public:
	...
	void update_pod(k8s_pod_t& pod, const nlohmann::json& item);
	...
	void update_event(k8s_event_t& evt, const nlohmann::json& item);
	...
	void enqueue_capture_event(const nlohmann::json& item);
...
private:
	...
	static k8s_component::type component_from_json(const nlohmann::json& item);
	static nlohmann::json extract_capture_data(const nlohmann::json& item);
