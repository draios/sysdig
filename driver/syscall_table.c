...
const struct syscall_evt_pair g_syscall_table[SYSCALL_TABLE_SIZE] = {
	...
	[__NR_clone - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP, PPME_SYSCALL_CLONE_19_E, PPME_SYSCALL_CLONE_19_X},
	[__NR_fork - SYSCALL_TABLE_ID0] =                       {UF_USED | UF_NEVER_DROP, PPME_SYSCALL_FORK_19_E, PPME_SYSCALL_FORK_19_X},
	[__NR_vfork - SYSCALL_TABLE_ID0] =                      {UF_USED | UF_NEVER_DROP, PPME_SYSCALL_VFORK_19_E, PPME_SYSCALL_VFORK_19_X},
