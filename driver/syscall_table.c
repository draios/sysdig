...
const struct syscall_evt_pair g_syscall_table[SYSCALL_TABLE_SIZE] = {
	...
	[__NR_mkdirat - SYSCALL_TABLE_ID0] =                    {UF_USED | UF_ALWAYS_DROP, PPME_SYSCALL_MKDIRAT_E, PPME_SYSCALL_MKDIRAT_X},
...
const struct syscall_evt_pair g_syscall_ia32_table[SYSCALL_TABLE_SIZE] = {
	...
	[__NR_ia32_mkdirat - SYSCALL_TABLE_ID0] =                    {UF_USED | UF_ALWAYS_DROP, PPME_SYSCALL_MKDIRAT_E, PPME_SYSCALL_MKDIRAT_X},
