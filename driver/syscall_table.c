...
//	[__NR_old_select] = 	{UF_USED, PPME_GENERIC_E, PPME_GENERIC_X},
...
#ifdef __x86_64__
	[__NR_socket] = 		{UF_USED | UF_NEVER_DROP, PPME_SOCKET_SOCKET_E, PPME_SOCKET_SOCKET_X},
	[__NR_bind] = 			{UF_USED, PPME_SOCKET_BIND_E,  PPME_SOCKET_BIND_X},
	[__NR_connect] = 		{UF_USED | UF_NEVER_DROP, PPME_SOCKET_CONNECT_E, PPME_SOCKET_CONNECT_X},
	[__NR_listen] = 		{UF_USED, PPME_SOCKET_LISTEN_E, PPME_SOCKET_LISTEN_X},
	[__NR_accept] = 		{UF_USED | UF_NEVER_DROP, PPME_SOCKET_ACCEPT_E, PPME_SOCKET_ACCEPT_X},
	...
	[__NR_shutdown] = 		{UF_USED | UF_NEVER_DROP, PPME_SOCKET_SHUTDOWN_E, PPME_SOCKET_SHUTDOWN_X},
...
#endif
	[__NR_accept4] = 		{UF_USED | UF_NEVER_DROP, PPME_SOCKET_ACCEPT4_E, PPME_SOCKET_ACCEPT4_X},
#else // __x86_64__
