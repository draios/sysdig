...
const struct ppm_event_entry g_ppm_events[PPM_EVENT_MAX] = {
	...
	[PPME_SYSCALL_CHOWN_E] = {FILLER_REF(sys_autofill), 2, APT_REG, {{1}, {2} } },
	[PPME_SYSCALL_CHOWN_X] = {FILLER_REF(sys_autofill), 2, APT_REG, {{AF_ID_RETVAL}, {0} } },
	[PPME_SYSCALL_LCHOWN_E] = {FILLER_REF(sys_autofill), 2, APT_REG, {{1}, {2} } },
	[PPME_SYSCALL_LCHOWN_X] = {FILLER_REF(sys_autofill), 2, APT_REG, {{AF_ID_RETVAL}, {0} } },
	[PPME_SYSCALL_FCHOWN_E] = {FILLER_REF(sys_autofill), 3, APT_REG, {{0}, {1}, {2} } },
	[PPME_SYSCALL_FCHOWN_X] = {FILLER_REF(sys_autofill), 1, APT_REG, {{AF_ID_RETVAL} } },
	[PPME_SYSCALL_FCHOWNAT_E] = {FILLER_REF(sys_fchownat_e)},
	[PPME_SYSCALL_FCHOWNAT_X] = {FILLER_REF(sys_autofill), 2, APT_REG, {{AF_ID_RETVAL}, {1} } },
	[PPME_SYSCALL_CHMOD_E] = {FILLER_REF(sys_autofill), 1, APT_REG, {{1} } },
	[PPME_SYSCALL_CHMOD_X] = {FILLER_REF(sys_autofill), 2, APT_REG, {{AF_ID_RETVAL}, {0} } },
	[PPME_SYSCALL_FCHMOD_E] = {FILLER_REF(sys_autofill), 2, APT_REG, {{0}, {1} } },
	[PPME_SYSCALL_FCHMOD_X] = {FILLER_REF(sys_autofill), 1, APT_REG, {{AF_ID_RETVAL} } },
	[PPME_SYSCALL_FCHMODAT_E] = {FILLER_REF(sys_fchmodat_e)},
