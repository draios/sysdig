...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SYSCALL_CHOWN_E */{"chown", EC_FILE, EF_NONE, 0},
	/* PPME_SYSCALL_CHOWN_X */{"chown", EC_FILE, EF_NONE, 4, {{"res", PT_ERRNO, PF_DEC}, {"pathname", PT_FSPATH, PF_NA}, {"owner", PT_UID, PF_DEC}, {"group", PT_GID, PF_DEC} } },
	/* PPME_SYSCALL_LCHOWN_E */{"lchown", EC_FILE, EF_NONE, 0},
	/* PPME_SYSCALL_LCHOWN_X */{"lchown", EC_FILE, EF_NONE, 4, {{"res", PT_ERRNO, PF_DEC}, {"pathname", PT_FSPATH, PF_NA}, {"owner", PT_UID, PF_DEC}, {"group", PT_GID, PF_DEC} } },
	/* PPME_SYSCALL_FCHOWN_E */{"fchown", EC_FILE, EF_NONE, 0},
	/* PPME_SYSCALL_FCHOWN_X */{"fchown", EC_FILE, EF_NONE, 4, {{"res", PT_ERRNO, PF_DEC}, {"fd", PT_FD, PF_DEC}, {"owner", PT_UID, PF_DEC}, {"group", PT_GID, PF_DEC} } },
	/* PPME_SYSCALL_FCHOWNAT_E */{"fchownat", EC_FILE, EF_NONE, 0},
	/* PPME_SYSCALL_FCHOWNAT_X */{"fchownat", EC_FILE, EF_NONE, 6, {{"res", PT_ERRNO, PF_DEC}, {"dirfd", PT_FD, PF_DEC}, {"pathname", PT_FSPATH, PF_NA}, {"owner", PT_UID, PF_DEC}, {"group", PT_GID, PF_DEC}, {"flags", PT_FLAGS32, PF_HEX, chown_chmod_flags} } },
	/* PPME_SYSCALL_CHMOD_E */{"chmod", EC_FILE, EF_NONE, 0},
	/* PPME_SYSCALL_CHMOD_X */{"chmod", EC_FILE, EF_NONE, 3, {{"res", PT_ERRNO, PF_DEC}, {"pathname", PT_FSPATH, PF_NA}, {"mode", PT_UINT32, PF_OCT} } },
	/* PPME_SYSCALL_FCHMOD_E */{"fchmod", EC_FILE, EF_NONE, 0},
	/* PPME_SYSCALL_FCHMOD_X */{"fchmod", EC_FILE, EF_NONE, 3, {{"res", PT_ERRNO, PF_DEC}, {"fd", PT_FD, PF_DEC}, {"mode", PT_UINT32, PF_OCT} } },
	/* PPME_SYSCALL_FCHMOD_E */{"fchmodat", EC_FILE, EF_NONE, 0},
	/* PPME_SYSCALL_FCHMOD_X */{"fchmodat", EC_FILE, EF_NONE, 5, {{"res", PT_ERRNO, PF_DEC}, {"dirfd", PT_FD, PF_DEC}, {"pathname", PT_FSPATH, PF_NA}, {"mode", PT_UINT32, PF_OCT}, {"flags", PT_FLAGS32, PF_HEX, chown_chmod_flags} } },
};
