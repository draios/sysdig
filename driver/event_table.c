...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] = {
	...
	/* PPME_SOCKET_SENDMMSG_E */{"sendmmsg", EC_IO_WRITE, (enum ppm_event_flags)(EF_USES_FD | EF_WRITES_TO_FD | EF_MODIFIES_STATE), 4, {{"fd", PT_FD, PF_DEC}, {"vlen", PT_UINT32, PF_DEC}, {"flags", PT_FLAGS32, PF_HEX, sendmsg_flags}, {"msgs", PT_MSGLIST, PF_NA} } },
	/* PPME_SOCKET_SENDMMSG_X */{"sendmmsg", EC_IO_WRITE, (enum ppm_event_flags)(EF_USES_FD | EF_WRITES_TO_FD | EF_MODIFIES_STATE), 1, {{"res", PT_ERRNO, PF_DEC} } },
