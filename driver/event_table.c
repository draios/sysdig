...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] =
{
	...
	/* PPME_SYSCALL_OPEN_X */{"open", EC_FILE, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 4, {{"fd", PT_FD, PF_DEC}, {"name", PT_FSPATH, PF_NA}, {"flags", PT_UINT32, PF_HEX}, {"mode", PT_UINT32, PF_HEX}}},
	...
	/* PPME_SOCKET_SOCKET_E */{"socket", EC_NET, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 3, {{"domain", PT_UINT32, PF_DEC}, {"type", PT_UINT32, PF_DEC}, {"proto", PT_UINT32, PF_DEC}}},
	...
	/* PPME_SOCKET_SHUTDOWN_E */{"shutdown", EC_NET, (ppm_event_flags)(EF_USES_FD | EF_MODIFIES_STATE), 2, {{"fd", PT_FD, PF_DEC}, {"how", PT_UINT8, PF_HEX}}},
	...
	/* PPME_SOCKET_SOCKETPAIR_E */{"socketpair", EC_IPC, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 3, {{"domain", PT_UINT32, PF_DEC}, {"type", PT_UINT32, PF_DEC}, {"proto", PT_UINT32, PF_DEC}}},
	...
	/* PPME_SYSCALL_EVENTFD_E */{"eventfd", EC_IPC, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 2, {{"initval", PT_UINT64, PF_DEC}, {"flags", PT_UINT32, PF_HEX}}},
	...
	/* PPME_SYSCALL_OPENAT_E */{"openat", EC_FILE, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 4, {{"dirfd", PT_FD, PF_DEC}, {"name", PT_CHARBUF, PF_NA}, {"flags", PT_UINT32, PF_HEX}, {"mode", PT_UINT32, PF_HEX}}},
	...
	/* PPME_SYSCALL_SIGNALFD_E */{"signalfd", EC_SIGNAL, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 3, {{"fd", PT_FD, PF_DEC}, {"mask", PT_UINT32, PF_HEX}, {"flags", PT_UINT8, PF_HEX}}},
	...
	/* PPME_SYSCALL_TIMERFD_CREATE_E */{"timerfd_create", EC_TIME, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 2, {{"clockid", PT_UINT8, PF_DEC}, {"flags", PT_UINT8, PF_HEX}}},
	/* PPME_SYSCALL_TIMERFD_CREATE_X */{"timerfd_create", EC_TIME, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 1, {{"res", PT_FD, PF_DEC}}},
	/* PPME_SYSCALL_INOTIFY_INIT_E */{"inotify_init", EC_IPC, (ppm_event_flags)(EF_CREATES_FD | EF_MODIFIES_STATE), 1, {{"flags", PT_UINT8, PF_HEX}}},
	...
	/* PPME_SYSCALL_FCNTL_E */{"fcntl", EC_IO_OTHER, (ppm_event_flags)(EF_USES_FD | EF_MODIFIES_STATE), 2, {{"fd", PT_FD, PF_DEC}, {"cmd", PT_UINT8, PF_DEC}}},
