...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] =
{
	...
	/* PPME_FCNTL_E */{"fcntl", EC_IO_OTHER, (ppm_event_flags)(EF_CREATES_FD | EF_USES_FD), 2, {{"fd", PT_FD, PF_DEC}, {"cmd", PT_FD, PF_DEC}}},
	/* PPME_FCNTL_X */{"fcntl", EC_IO_OTHER, (ppm_event_flags)(EF_CREATES_FD | EF_USES_FD), 1, {{"res", PT_FD, PF_DEC}}},
};
