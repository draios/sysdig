...
const struct ppm_event_info g_event_info[PPM_EVENT_MAX] =
{
	...
	/* PPME_SYSCALL_OPEN_X */{"open", EC_FILE, EF_CREATES_FD, 4, {{"fd", PT_FD, PF_DEC}, {"name", PT_FSPATH, PF_NA}, {"flags", PT_FLAGS32, PF_HEX}, {"mode", PT_UINT32, PF_HEX}}},
	...
	/* PPME_SYSCALL_OPENAT_E */{"openat", EC_FILE, EF_CREATES_FD, 4, {{"dirfd", PT_FD, PF_DEC}, {"name", PT_CHARBUF, PF_NA}, {"flags", PT_FLAGS32, PF_HEX}, {"mode", PT_UINT32, PF_HEX}}},
