...
struct bpf_map_def SEC("maps") tail_map = {
...
struct bpf_map_def SEC("maps") syscall_code_routing_table = {
...
struct bpf_map_def SEC("maps") event_info_table = {
	.type = BPF_MAP_TYPE_ARRAY,
	.key_size = sizeof(u32),
...
struct bpf_map_def SEC("maps") fillers_table = {
	.type = BPF_MAP_TYPE_ARRAY,
	.key_size = sizeof(u32),
...
struct bpf_map_def SEC("maps") frame_scratch_map = {
	.type = BPF_MAP_TYPE_ARRAY,
	.key_size = sizeof(u32),
...
struct bpf_map_def SEC("maps") tmp_scratch_map = {
	.type = BPF_MAP_TYPE_ARRAY,
	.key_size = sizeof(u32),
	.value_size = SCRATCH_SIZE,
	.max_entries = 0,
