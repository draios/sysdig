...
/* Unfortunately, BTF does not record #define constants
 * and we have to define some macros here.
 * To avoid architecture issues all the macros needs to be defined for
