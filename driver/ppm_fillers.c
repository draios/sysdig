...
const struct ppm_event_entry g_ppm_events[PPM_EVENT_MAX] = {
	...
	[PPME_SYSCALL_VMSPLICE_E] = {PPM_AUTOFILL, 2, APT_REG, {{0}, {3} } },
	[PPME_SYSCALL_VMSPLICE_X] = {PPM_AUTOFILL, 1, APT_REG, {{AF_ID_RETVAL} } },
	[PPME_SYSCALL_TEE_E] = {PPM_AUTOFILL, 4, APT_REG, {{0}, {1}, {2}, {3} } },
	[PPME_SYSCALL_TEE_X] = {PPM_AUTOFILL, 1, APT_REG, {{AF_ID_RETVAL} } },
	[PPME_SYSCALL_SENDFILE_E] = {PPM_AUTOFILL, 3, APT_REG, {{0}, {1}, {3} } },
	[PPME_SYSCALL_SENDFILE_X] = {PPM_AUTOFILL, 1, APT_REG, {{AF_ID_RETVAL} } },
