...
static int f_sys_linkat_x(struct event_filler_arguments *args);
...
const struct ppm_event_entry g_ppm_events[PPM_EVENT_MAX] = {
	...
	[PPME_SYSCALL_OPENAT_2_E] = {f_sys_empty},
	[PPME_SYSCALL_OPENAT_2_X] = {f_sys_openat_x},
	[PPME_SYSCALL_LINK_2_E] = {f_sys_empty},
	[PPME_SYSCALL_LINK_2_X] = {PPM_AUTOFILL, 3, APT_REG, {{AF_ID_RETVAL}, {0}, {1} } },
	[PPME_SYSCALL_LINKAT_2_E] = {f_sys_empty},
	[PPME_SYSCALL_LINKAT_2_X] = {f_sys_linkat_x},
	...
	[PPME_SYSCALL_MKDIR_2_E] = {f_sys_empty},
	[PPME_SYSCALL_MKDIR_2_X] = {PPM_AUTOFILL, 3, APT_REG, {{AF_ID_RETVAL}, {0}, {1} } },
