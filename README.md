...
---
###Background
As sysdig matures and gains wider acceptance, we are formalizing the way that we accept contributions of code from the contributing community. We must now ask that contributions to sysdig be provided subject to the terms and conditions of a Contributor License Agreement, the complete text of which is available [here](https://github.com/draios/sysdig/tree/dev/cla). The CLA comes in two forms, applicable to contributions by individuals, or by legal entities such as corporations and their employees. We recognize that entering into a CLA with us involves consideration on the part of contributors and we regret any inconvenience. Note that the agreement is not a transfer of copyright ownership, this simply is a license agreement for contributions, intended to clarify the intellectual property license granted with Contributions from any person or entity. It is for your protection as a Contributor as well as the protection of sysdig; it does not change your rights to use your own Contributions for any other purpose.
